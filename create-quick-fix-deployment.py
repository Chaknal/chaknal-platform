#!/usr/bin/env python3
"""
Create quick fix deployment package
This script creates a deployment package with the fixed main.py
"""
...
def create_quick_fix_deployment():
    """Create quick fix deployment package"""
    print("🚀 Creating quick fix deployment package...")
    
    # Create temporary directory
    temp_dir = "/tmp/quick-fix-deployment"
    ...
    api_files = [
        ...
        "app/main.py"  # This should now be the rebuilt version
    ]
...
# Start command - use main.py (which should be the rebuilt version)
CMD ["python", "-m", "uvicorn", "app.main:app", "--host", "0.0.0.0", "--port", "8000"]"""
    ...
    zip_filename = f"chaknal-quick-fix-{timestamp}.zip"
    ...
    print(f"✅ Quick fix deployment package created: {zip_filename}")
    print("📋 Package includes the fixed main.py with rebuilt API routers")
    print("🎯 Ready for Azure deployment!")
    
    return zip_filename

if __name__ == "__main__":
    create_quick_fix_deployment()
