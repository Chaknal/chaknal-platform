...
async def populate_production_data():
    ...
    async with async_session_maker() as session:
        try:
            ...
            await session.flush()
            print("✅ Created organization: Sales Team")
            ...
            contacts_data = [
                ...
                },
                {
                    "first_name": "Lisa",
                    "last_name": "Wilson",
                    "email": "lisa.wilson@scale.com",
                    "company_name": "Scale Technologies",
                    "job_title": "Head of Sales",
                    "linkedin_url": "https://linkedin.com/in/lisawilson"
                },
                {
                    "first_name": "David",
                    "last_name": "Brown",
                    "email": "david.brown@future.com",
            ...
            print(f"   Organization: Sales Team")
